   ...
   <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card text-center">
                <div class="card-header ">{{ __('Añadir película') }}</div>
                  <div class="card-body">
                     ...
                     <div class="form-group row">
                           ...
                           <div class="col-md-6">
                              <input id="poster" type="text" class="form-control" name="poster" required autofocus>
                           </div>
                     </div>
                     ...
                     <div class="form-group row">
                           ...
                           <div class="col-md-6">
                              <textarea name="synopsis" class="form-control" id="synopsis" name="synopsis" cols="30" rows="10" required autofocus></textarea>
                           </div>
                     </div>
